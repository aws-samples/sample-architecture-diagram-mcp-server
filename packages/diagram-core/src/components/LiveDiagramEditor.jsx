...
function EditorCanvas({
  value, onChange, lang = "en", direction = "TB", geometry, nodeLayout = "horizontal",
  vars = {}, Icon, markerId = "ld-arrow", editorRef,
}) {
  ...
  const decorateGroup = useCallback((n) => n.type === "group"
    ? { ...n, data: { ...n.data, id: n.id, label: tr(n.data?.label, lang),
        ...
        IconComponent: Icon, scale: nodeLayout === "horizontal" ? "lg" : "sm", vars } }
  ...
  useImperativeHandle(editorRef, () => ({
    ...
    addGroup(variantName = "group", label = "Group") {
      ...
      const node = {
        ...
        data: { id: gid, label, variant: variantName, IconComponent: Icon, scale: nodeLayout === "horizontal" ? "lg" : "sm", vars },
  ...
  }), [nodes, edges, setNodes, setEdges, screenToFlowPosition, fitView, decorateGroup, lang, vars, Icon, geom, nodeLayout, direction]);
