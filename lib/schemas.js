...
export const serviceSchema = z.object({
  ...
  shape: z.string(),
  icon: z.string().optional().describe("Explicit icon reference — overrides name-based resolution. Bare name resolves under icons/ (e.g. 'Arch_Amazon-RDS_48.png'), prefixed path used as-is (e.g. 'aws-icons/kiro.svg', 'tech-icons/whatsapp.svg'). Set this whenever `service` is free-text or non-AWS so the node still gets a real icon instead of an initial. Call resolve_icon to discover valid names/filenames."),
