...
function serviceCell(id, service, shape, category, x, y, label, parentId) {
  ...
  const container = `        <mxCell id="${grpId}" value="" style="fillColor=${cat.tint};strokeColor=${cat.stroke};rounded=1;whiteSpace=wrap;html=1;verticalAlign=top;fontStyle=1;fontSize=10;fontColor=${cat.stroke};fontFamily=Helvetica;container=1;collapsible=0;shadow=1;strokeWidth=1.5;" vertex="1" parent="${parent}">
...
export function generateDrawio(title, subtitle, services, connections, groups, options = {}) {
  ...
  return `<mxfile host="Electron" version="29.6.1">
...
function usersCell(x, y) {
  return `        <mxCell id="users-container" style="fillColor=#f5f5f5;strokeColor=light-dark(#666666,#D4D4D4);rounded=1;whiteSpace=wrap;html=1;verticalAlign=top;fontStyle=1;fontSize=12;fontColor=#333333;fontFamily=Helvetica;container=1;collapsible=0;shadow=1;strokeWidth=1;" value="Users" vertex="1" parent="1">
...
function externalsCell(externals) {
  ...
  let cells = `        <mxCell id="ext-container" style="fillColor=#f5f5f5;strokeColor=light-dark(#666666,#D4D4D4);rounded=1;whiteSpace=wrap;html=1;verticalAlign=top;fontStyle=1;fontSize=11;fontColor=#333333;fontFamily=Helvetica;container=1;collapsible=0;shadow=1;strokeWidth=1;" value="External Integrations" vertex="1" parent="1">
